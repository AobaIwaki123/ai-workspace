...
- **演習環境**: クラウド（AWS EC2 / CloudFormation）
...
| **Step 2** | **基礎知識・計測フローの習得** | alp, pt-query-digest, pprof/clinic等の計測サイクルの理解 | ✅ 完了 ([note](note/)) |
...
- [ ] AWS上でのISUCON過去問（例: ISUCON11予選 または ISUCON12予選）の環境構築
- [ ] Go / TypeScript 向けプロファイラ・ビルド用Makefileの拡充
- [ ] 1回目のチーム模擬演習のスケジュール調整と実施
