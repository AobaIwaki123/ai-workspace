...
| モデル規模 | 量子化 | VRAM 消費 | Prompt 処理速度 (pp128) | **Token 生成速度 (tg64)** | 1 トークン所要時間 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **0.5B (Qwen2.5)** | Q4_K_M | 約 500 MiB | **247.8 tokens/sec** | **59.8 tokens/sec** | 16.7 ms / token |
| **1.5B (Qwen2.5)** | Q4_K_M | 約 1,150 MiB | **124.0 tokens/sec** | **28.2 tokens/sec** | 35.5 ms / token |
| **3.0B (Qwen2.5)** | Q4_K_M | 約 2,250 MiB | **56.4 tokens/sec** | **14.2 tokens/sec** | 70.4 ms / token |
| **3.0B (Nanbeige)** | Q4_K_M | 約 2,550 MiB | **52.1 tokens/sec** | **13.5 tokens/sec** | 74.0 ms / token |

### 3.2 モデルサイズに対する実測ダウンロード・切り替え時間

| モデル名 | ファイルサイズ | ダウンロード実測 | 実効転送レート | VRAM ロード時間 | **合計切り替え所要時間** |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **0.5B (Q4)** | 0.39 GB (398 MB) | **9 秒** | 44.2 MB/s (353 Mbps) | 0.8 秒 | **約 10 秒** |
| **1.5B (Q4)** | 1.06 GB (1,065 MB) | **25 秒** | 42.6 MB/s (340 Mbps) | 1.8 秒 | **約 28 秒** |
| **3.0B (Q4)** | 2.01 GB (2,007 MB) | **46 秒** | 43.6 MB/s (348 Mbps) | 2.6 秒 | **約 50 秒** |
| **3.0B (Nanbeige)** | 2.56 GB (2,559 MB) | **87 秒 (1分27秒)** | 29.4 MB/s (235 Mbps) | 3.2 秒 | **約 92 秒 (1分32秒)** |
